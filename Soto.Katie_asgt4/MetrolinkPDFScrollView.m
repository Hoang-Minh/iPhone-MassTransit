...
#import "MetrolinkPDFScrollView.h"
#import "MetrolinkPDFTiledView.h"
#import <QuartzCore/QuartzCore.h>

//****************************************
@interface MetrolinkPDFScrollView ()

// A low resolution image of the PDF page that is displayed until the MetrolinkPDFTiledView renders its content.
@property (nonatomic, weak) UIImageView *backgroundImageView;

// The MetrolinkPDFTiledView that is currently front most.
@property (nonatomic, weak) MetrolinkPDFTiledView *tiledPDFView;

// The old MetrolinkPDFTiledView that we draw on top of when the zooming stops.
@property (nonatomic, weak) MetrolinkPDFTiledView *oldMetrolinkPDFTiledView;

@end

//****************************************
@implementation MetrolinkPDFScrollView
{
...
@synthesize backgroundImageView=_backgroundImageView, tiledPDFView=_tiledPDFView, oldMetrolinkPDFTiledView=_oldMetrolinkPDFTiledView;
...
- (void)setPDFPage:(CGPDFPageRef)PDFPage;
{
    ...
    MetrolinkPDFTiledView *tiledPDFView = [[MetrolinkPDFTiledView alloc] initWithFrame:pageRect scale:_PDFScale];
...
- (void)scrollViewWillBeginZooming:(UIScrollView *)scrollView withView:(UIView *)view
{
    ...
    [self.oldMetrolinkPDFTiledView removeFromSuperview];
    
    // Set the current TiledPDFView to be the old view.
    self.oldMetrolinkPDFTiledView = self.tiledPDFView;
    [self addSubview:self.oldMetrolinkPDFTiledView];
}
