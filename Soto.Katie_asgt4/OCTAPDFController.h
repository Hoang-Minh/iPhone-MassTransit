...
//  File Description: This file loads a pdf from a local resource and displays it. Note
//      that it also uses "PDFScrollView" and "TiledPDFView".
//
...
@interface OCTAPDFController : UIViewController
